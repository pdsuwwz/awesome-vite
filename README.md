...
😎 Awesome for Vite5/4 / Vue3 / Webpack5 Apps written by myself. 💯 
...
- [vite-starter](https://github.com/pdsuwwz/vite-starter) - 🐟 Starter template for Vite 5.x + Vue 3.x
- [vite-ts-starter](https://github.com/pdsuwwz/vite-ts-starter) - 🐬  A Starter template built on Vite 5.x + Vue 3.x + Typescript / 一个开箱即用，适合快速迭代的启动模版。
